...
class DatasetWrapper(object):
	...
	class __DatasetWrapper(object):
		...
		def __init__(self, params):	
			...
			datapath = '../../data/BRISC/segmentation_task/train'
			folder = os.path.join(datapath, 'images')
			if os.path.isdir(folder):
				trainset = [[datapath, image] for image in os.listdir(folder) if '.png' in image]

			trainset.sort()

			datapath = '../../data/BRISC/segmentation_task/test'
			folder = os.path.join(datapath, 'images')
			if os.path.isdir(folder):
				testset = [[datapath, image] for image in os.listdir(folder) if '.png' in image]
...
class imageDataset(Dataset):
	...
	def __getitem__(self, idx):
		...
		data = Image.open(self.DatasetWrapper.features(sample)).convert("L")
